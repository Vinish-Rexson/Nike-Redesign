...
<ul class="nav nav-tabs mb-3" role="tablist" id="jazzy-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link{% if forloop.first %} active{% endif %}" data-toggle="pill" role="tab"
...
<div class="tab-content">
    ...
    <div id="{{ fieldset.name|default:general_tab|unicode_slugify }}-tab"
         class="tab-pane fade{% if forloop.first %} active show{% endif %} {{ fieldset.classes }}" role="tabpanel"
