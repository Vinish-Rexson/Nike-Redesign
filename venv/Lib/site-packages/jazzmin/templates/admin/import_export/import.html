...
<div class="col-12">
    {% if confirm_form %}
    <form action="{% url opts|admin_urlname:" process_import
    " %}" method="POST">
    {% csrf_token %}
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12 col-lg-9">
                        {{ confirm_form.as_p }}
                        <p>
                            {% trans "Below is a preview of data to be imported. If you are satisfied with the results,
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="submit" class="btn {{ jazzmin_ui.button_classes.success }} form-control"
                               name="confirm" value="{% trans " Confirm import" %}">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="form-group field-name">
                            <div class="row">
                                ...
                                <div class="help-block red">
                                    ...
                                    width="10" height="10" alt="({{ field.field.help_text|striptags }})" title="{{
            ...
            <div class="col-12 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <input type="submit" class="btn {{ jazzmin_ui.button_classes.success }} form-control"
                                   name="confirm" value="{% trans " Submit" %}">
                        </div>
                    </div>
                </div>
            </div>
