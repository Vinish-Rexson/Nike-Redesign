...
<div id="jazzy-carousel" class="carousel slide" data-ride="false" data-wrap="false" data-keyboard="true"
     data-interval="false">
    <div class="row">
        <div class="col-sm-2">
            <a href="#jazzy-carousel" role="button" data-slide="prev"
               class="btn {{ jazzmin_ui.button_classes.primary }}"><i class="fas fa-arrow-left"></i></a>
        </div>
        ...
        <div class="col-sm-2">
            <a href="#jazzy-carousel" role="button" data-slide="next"
               class="btn {{ jazzmin_ui.button_classes.primary }} float-right"><i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
