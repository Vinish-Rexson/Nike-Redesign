...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{% url opts|admin_urlname:'changelist' %}">{{ opts.verbose_name_plural|capfirst
        }}</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                <a href="#" class="btn {{ jazzmin_ui.button_classes.danger }} cancel-link form-control">{%
