...
<div>
    ...
    <div class="form-group">
        <input type="submit" value="{% trans 'Save' %}" class="btn {{ jazzmin_ui.button_classes.success }} form-control"
               name="_save">
    </div>
    {% endif %}
    ...
    {% if show_save_as_new %}
    <div class="form-group">
        <input type="submit" class="btn {{ jazzmin_ui.button_classes.info }} form-control"
    ...
    <div class="form-group">
        <a href="{% url opts|admin_urlname:'changelist' %}"
           class="btn {{ jazzmin_ui.button_classes.danger }} form-control">{% trans 'Close' %}</a>
    </div>
    {% endif %}
