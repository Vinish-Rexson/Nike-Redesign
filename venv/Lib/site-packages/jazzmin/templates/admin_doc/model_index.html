...
<div class="row">
    <div class="col-4 col-sm-2">
        <div class="nav flex-column nav-tabs h-100" id="tabs-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" id="tabs-{{ group.grouper.label }}-control" data-toggle="pill"
               href="#tabs-{{ group.grouper.label }}" role="tab" aria-controls="tabs-{{ group.grouper.label }}"
               aria-selected="true">
    ...
    <div class="col-7 col-sm-9">
        <div class="tab-content" id="tabs-tabContent">
            ...
            <div class="tab-pane text-left fade{% if forloop.first %} show active{% endif %}"
                 id="tabs-{{ group.grouper.label }}" role="tabpanel"
                 aria-labelledby="tabs-{{ group.grouper.label }}-control">
