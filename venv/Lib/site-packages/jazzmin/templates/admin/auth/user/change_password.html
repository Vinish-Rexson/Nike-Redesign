...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{% url opts|admin_urlname:'change' original.pk|admin_urlquote %}">{{
        original|truncatewords:"18" }}</a></li>
                        ...
                        <div class="row">
                            <div class="submit-row col-md-12 col-md-push-2">
                                <input type="submit" value="{% trans 'Change password' %}"
                                       class="btn {{ jazzmin_ui.button_classes.primary }} float-right">
                            </div>
                        </div>
                    </div>
                </form>
