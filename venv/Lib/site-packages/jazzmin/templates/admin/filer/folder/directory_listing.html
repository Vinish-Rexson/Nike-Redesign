...
{% if not is_popup %}
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{% url 'admin:index' %}" title="{% trans 'Go back to admin homepage' %}"><i
            class="fas fa-tachometer-alt"></i> {% trans 'Home' %}</a></li>
    ...
    <li class="breadcrumb-item"><a href="{% url 'admin:filer-directory_listing-root' %}"
                                   title="{% trans 'Go back to root folder' %}">{% trans "root" %}</a></li>
    {% endif %}
    ...
    <div class="breadcrumbs-container-wrapper">
        <div class="breadcrumbs-container">
            <div class="breadcrumbs-container-inner">
                ...
                <div class="navigator-breadcrumbs">
                    <div class="filer-navigator-breadcrumbs-dropdown-container filer-dropdown-container">
                        <a href="#" data-toggle="filer-dropdown" aria-expanded="false">
                            <img src="{% static 'filer/icons/breadcrubms_dropdown_28_28.png' %}" alt="" width="28"
                                 height="28">
                        </a>
                            ...
                            <li>
                                <a href="{% url 'admin:filer-directory_listing' folder.id %}{% filer_admin_context_url_params %}"
                                   title="{% trans 'Go back to the parent folder' %}">
                                    <img src="{% static 'filer/icons/plainfolder_48x48.png' %}"
                                         alt="{% trans 'Folder Icon' %}" width="28" height="28">
                                    {{ folder.name }}
                                </a>
                            </li>
                            {% endfor %}
                            <li>
                                <a href="{% url 'admin:filer-directory_listing-root' %}{% filer_admin_context_url_params %}"
                                   title="{% trans 'Go back to' %} {% trans 'root'|title %} {% trans 'folder' %}">
                                    <img src="{% static 'filer/icons/root_28x28.png' %}" alt="{% trans 'Folder Icon' %}"
                                         width="28" height="28">
                                    Root
                                </a>
                            </li>
                ...
                <div class="navigator-breadcrumbs-name-dropdown-wrapper">
                    ...
                    <div class="filer-dropdown-container filer-dropdown-container-down">
                        ...
                        <ul class="filer-dropdown-menu">
                            <li>
                                <a href="{% url 'admin:filer_folder_change' folder.id %}"
                                   title="{% trans 'Change current folder details' %}">{% trans "Change" %}</a>
                            </li>
                        </ul>
                        {% endif %}
                    </div>
                ...
                <form class="filter-files-container js-filter-files-container" action="." method="get"
                      class="js-filer-search-form">
                    <div class="filter-filers-container-inner">
                        <button class="navigator-button filter-files-button"
                                title="{% trans 'Click here to run search for entered phrase' %}"><span
                                class="icon fa fa-search"></span></button>
                        <div class="filter-search-wrapper">
                            {% filer_admin_context_hidden_formfields %}
                            <input type="text" placeholder="{% trans 'Search' %}"
                                   class="filter-files-field js-filter-files" value="{{ search_string }}" name="q">
                            <div class="filer-dropdown-container filer-dropdown-container-down">
                                <a href="#" data-toggle="filer-dropdown" aria-expanded="false">
                                    <span class="fa fa-caret-down"></span>
                                </a>
            ...
            <div class="navigator-tools">
                ...
                <div class="actions-wrapper">
                    <ul class="actions-separated-list">
                        <li>
                            <a href="#" class="js-action-delete" title="{% trans 'Delete' %}"><span
                                    class="fa fa-trash"></span></a>
                        </li>
                        <li>
                            <a href="#" class="js-action-copy" title="{% trans 'Copy' %}"><span
                                    class="fa fa-copy"></span></a>
                        </li>
                        <li>
                            <a href="#" class="js-action-move" title="{% trans 'Move' %}"><span
                                    class="fa fa-cut"></span></a>
                        </li>
                    </ul>
                    <div class="filer-dropdown-container js-actions-menu">
                        <a href="#" data-toggle="filer-dropdown" aria-expanded="false"
                           class="nav-button nav-button-dots">
